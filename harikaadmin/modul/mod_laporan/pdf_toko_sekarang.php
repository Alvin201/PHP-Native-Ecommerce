...
$pdf->addJpegFromFile('../../../foto_banner/22_big.jpg',20,800,69);

// Teks di tengah atas untuk judul header
$pdf->addText(180, 820, 16,'<b>Laporan Penjualan Harian</b>');
$pdf->addText(200, 800, 18,'<b>Harica Music</b>');
...
$sql = mysql_query("SELECT orders.id_orders as faktur,DATE_FORMAT(tgl_order, '%Y-%m-%d') as tanggal,
                    nama_album,jumlah,harga 
                    FROM orders, orders_detail, album  
